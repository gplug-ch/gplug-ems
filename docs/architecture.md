# gPlug EMS — architecture

How the EMS is put together: the parts of a site, the allocation algorithm, and
which computation runs on the device versus in the browser. For installation and
usage see the [README](../README.md); for developer workflows see
[`ems/README.md`](../ems/README.md).
...
See the `CLAUDE.md` files in each component directory for commands and detailed
architecture, and [`features.md`](features.md) for the feature-level spec.
